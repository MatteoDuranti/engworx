...
namespace System.Web.Helpers {
    ...
    public class GenericWebGridRow : DynamicObject, IEnumerable<object> {
        ...
        public IHtmlString GetSelectLink(string text = null) {
            ...
            return new HtmlString(WebGrid.GetLinkHtml(GetSelectUrl(), text));
        }
